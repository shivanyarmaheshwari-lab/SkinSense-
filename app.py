    ...
    components.html(
        ...
        <script>
            ...
            async function speakSkinSense{widget_id}() {{
                    ...
                    if ({json.dumps(lang)} === "mr-IN" && voiceChoice.fallback) {{
                        output.style.display = "block";
                        output.textContent = "Marathi voice is not installed in this browser/device. I am using the closest Indian voice available. Marathi works best on Android Chrome or devices with a Marathi voice installed.";
                    }}
