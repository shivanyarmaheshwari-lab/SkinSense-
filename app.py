...
TEXT = {
    "English": {
        ...
        "exact_location_map": "Map centered on your typed location",
    ...
    "हिंदी": {
        ...
        "exact_location_map": "आपके लिखे हुए location पर centered map",
    ...
    "मराठी": {
        ...
        "exact_location_map": "तुम्ही लिहिलेल्या location वर centered map",
    ...
    if not location:
        ...
        try:
            ...
            if geocoded is None:
                ...
                components.iframe(exact_location_embed_url(lat, lon), height=300, scrolling=False)
