...
TEXT = {
    "English": {
        ...
        "derm_help": "Enter your area, village, or city. SkinSense will show Google Maps searches focused on public hospitals, clinics, and lower-cost dermatology care.",
        "location_label": "Your area or city",
    ...
    "हिंदी": {
        ...
        "derm_help": "अपना area, गांव या शहर लिखें. SkinSense Google Maps पर सरकारी अस्पताल, public clinic और कम खर्च वाले dermatology options दिखाएगा.",
        "location_label": "आपका area या शहर",
    ...
    "मराठी": {
        ...
        "derm_help": "तुमचा area, गाव किंवा शहर लिहा. SkinSense Google Maps वर सरकारी रुग्णालये, public clinics आणि कमी खर्चाचे dermatology options दाखवेल.",
        "location_label": "तुमचा area किंवा शहर",
        "location_placeholder": "उदाहरण: Versova, Mumbai",
...
def dermatologist_page() -> None:
    ...
    if not location:
        ...
        search_options = {
            t("government_hospitals"): f"government hospital dermatologist near {location}",
            t("public_clinics"): f"public health clinic skin dermatologist near {location}",
            t("low_cost_derm"): f"low cost dermatologist charitable hospital skin clinic near {location}",
        }
